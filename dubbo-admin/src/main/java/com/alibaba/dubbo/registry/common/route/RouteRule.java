...
public class RouteRule {
    public static class MatchPair {
        ...
        public boolean pass(String sample) {
            return !unmatches.contains(sample) && (matches.isEmpty() || matches.contains(sample));
        }
    ...
    public boolean isWhenContainValue(String key, String value) {
        ...
        return null != matchPair && matchPair.containeValue(value);
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + (thenCondition.hashCode());
        result = prime * result + (whenCondition.hashCode());
        return result;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!thenCondition.equals(other.thenCondition))
            return false;
